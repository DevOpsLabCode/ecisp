...
from EnterpriseCloudDiscovery.core.console import print_error, print_info
...
from EnterpriseCloudDiscovery.providers.kubernetes.utils import format_api_version, format_resource_id, format_resource_kind, format_resource_name
...
class KubernetesBaseFacade:
    ...
    def __init__(self, credentials: KubernetesCredentials) -> None:
        ...
        self.api_client.user_agent = f'Enterprise Cloud Discovery Engine {__version__}'
