...
from EnterpriseCloudDiscovery.providers.kubernetes.services import KubernetesServicesConfig
from EnterpriseCloudDiscovery.utils import formatted_service_name
