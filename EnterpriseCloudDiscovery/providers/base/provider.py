...
from EnterpriseCloudDiscovery import __version__ as scout_version
from EnterpriseCloudDiscovery.core.console import print_exception, print_info, print_error
from EnterpriseCloudDiscovery.output.html import ScoutReport
from EnterpriseCloudDiscovery.providers.base.configs.browser import get_object_at
...
class BaseProvider:
    ...
    def manage_object(self, object, attr, init, callback=None):
        """
        This is a quick-fix copy of Opinel's manage_dictionary in order to support the new EnterpriseCloudDiscovery object which isn't
        a dict
        """
        if type(object) == dict:
