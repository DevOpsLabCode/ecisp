...
from EnterpriseCloudDiscovery.core.console import print_exception, print_debug, print_info
from EnterpriseCloudDiscovery.providers.aws.utils import get_partition_name
