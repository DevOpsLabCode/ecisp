...
from EnterpriseCloudDiscovery.providers.aws.utils import get_name, format_arn
...
class RegionalSettings(AWSResources):
    ...
    async def fetch_all(self):
        ...
        # However, EnterpriseCloudDiscovery seems to assume that every setting is tied to a resource so we make 
