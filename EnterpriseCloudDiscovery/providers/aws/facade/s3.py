...
from EnterpriseCloudDiscovery.core.console import print_exception, print_debug, print_warning
        ...
        try:
            ...
            for region in region_list:
                try:
                    ...
                    exception = None  # Fix for /issues/916#issuecomment-728783965
                    break
            if not buckets:
                if exception:
