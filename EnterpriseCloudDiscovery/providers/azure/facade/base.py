from EnterpriseCloudDiscovery.providers.azure.authentication_strategy import AzureCredentials
from EnterpriseCloudDiscovery.providers.azure.facade.aad import AADFacade
from EnterpriseCloudDiscovery.providers.azure.facade.rbac import RBACFacade
from EnterpriseCloudDiscovery.providers.azure.facade.keyvault import KeyVaultFacade
from EnterpriseCloudDiscovery.providers.azure.facade.network import NetworkFacade
from EnterpriseCloudDiscovery.providers.azure.facade.resourcemanagement import ResourceManagementFacade
from EnterpriseCloudDiscovery.providers.azure.facade.securitycenter import SecurityCenterFacade
from EnterpriseCloudDiscovery.providers.azure.facade.sqldatabase import SQLDatabaseFacade
from EnterpriseCloudDiscovery.providers.azure.facade.storageaccounts import StorageAccountsFacade
from EnterpriseCloudDiscovery.providers.azure.facade.virtualmachines import VirtualMachineFacade
from EnterpriseCloudDiscovery.providers.azure.facade.appservice import AppServiceFacade
from EnterpriseCloudDiscovery.providers.azure.facade.mysqldatabase import MySQLDatabaseFacade
from EnterpriseCloudDiscovery.providers.azure.facade.postgresqldatabse import PostgreSQLDatabaseFacade
from EnterpriseCloudDiscovery.providers.azure.facade.loggingmonitoring import LoggingMonitoringFacade

from azure.mgmt.resource import SubscriptionClient
from EnterpriseCloudDiscovery.providers.base.authentication_strategy import AuthenticationException
from EnterpriseCloudDiscovery.utils import get_user_agent

from EnterpriseCloudDiscovery.core.console import print_info, print_exception

# Try to import proprietary services
try:
    from EnterpriseCloudDiscovery.providers.azure.facade.appgateway_private import AppGatewayFacade
except ImportError:
    pass
try:
    from EnterpriseCloudDiscovery.providers.azure.facade.loadbalancer_private import LoadBalancerFacade
except ImportError:
    pass
try:
    from EnterpriseCloudDiscovery.providers.azure.facade.rediscache_private import RedisCacheFacade
except ImportError:
    pass
