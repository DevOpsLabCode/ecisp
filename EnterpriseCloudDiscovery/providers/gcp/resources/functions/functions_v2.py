from EnterpriseCloudDiscovery.providers.base.resources.base import Resources
...
from EnterpriseCloudDiscovery.providers.gcp.resources.functions.utils import get_environment_secrets
