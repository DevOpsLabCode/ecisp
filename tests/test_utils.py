# Import AWS utils
from EnterpriseCloudDiscovery.providers.aws.utils import (
    get_keys,
    no_camel,
    get_name,
    is_throttled,
...
from EnterpriseCloudDiscovery.utils import *
import collections
import unittest
...
#
# Test methods for EnterpriseCloudDiscovery/utils.py
#
class TestScoutUtilsClass(unittest.TestCase):
    ...
    def test_get_identity(self):
        with mock.patch(
            "EnterpriseCloudDiscovery.providers.aws.utils.get_caller_identity",
