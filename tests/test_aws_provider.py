...
from EnterpriseCloudDiscovery.providers.aws.authentication_strategy import AWSCredentials
...
class TestAWSProviderClass(unittest.TestCase):
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.authentication_strategy.boto3")
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.authentication_strategy.get_caller_identity")
    ...
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.facade.base.get_aws_account_id")
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.facade.base.get_partition_name")
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.provider.get_aws_account_id")
    @mock.patch("EnterpriseCloudDiscovery.providers.aws.provider.get_partition_name")
