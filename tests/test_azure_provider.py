...
class TestAzureProviderClass(unittest.TestCase):
    @mock.patch("EnterpriseCloudDiscovery.providers.azure.authentication_strategy.UsernamePasswordCredential")
    ...
    @mock.patch("EnterpriseCloudDiscovery.providers.azure.authentication_strategy.AzureCliCredential")
