...
import unittest
from EnterpriseCloudDiscovery.core.console import set_logger_configuration, print_debug
from EnterpriseCloudDiscovery.core.rule import Rule
...
class TestScoutRulesRuleset(unittest.TestCase):
    ...
    @mock.patch("EnterpriseCloudDiscovery.core.ruleset.print_error")
    ...
    @mock.patch("EnterpriseCloudDiscovery.core.ruleset.print_exception")
    ...
    def test_path_for_cloud_providers(self):
        ...
        assert (os.path.samefile(target.rules_data_path, './EnterpriseCloudDiscovery/providers/aws/rules'))

        target = Ruleset(cloud_provider='azure', filename=self.test_ruleset_001)
        assert (os.path.samefile(target.rules_data_path, './EnterpriseCloudDiscovery/providers/azure/rules'))

        target = Ruleset(cloud_provider='gcp', filename=self.test_ruleset_001)
        assert (os.path.samefile(target.rules_data_path, './EnterpriseCloudDiscovery/providers/gcp/rules'))

    def test_path_for_ruletypes(self):
        rpath = "./EnterpriseCloudDiscovery/providers/aws/rules/"
    ...
    @mock.patch("EnterpriseCloudDiscovery.core.ruleset.prompt_yes_no")
