...
from EnterpriseCloudDiscovery.providers.aws.utils import get_caller_identity
...
def format_finding_to_securityhub_format(aws_account_id,
    ...
    try:
        ...
        formatted_finding = {
            ...
            'GeneratorId': f'enterprise_cloud_discovery-{aws_account_id}',
            ...
            'ProductFields': {'Product Name': 'Enterprise Cloud Discovery Engine'},
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--file',
                        ...
                        help="The path of the JSON results file to process, e.g. "
                             "\"enterprise_cloud_discovery-report/enterprise_cloud_discovery-results/enterprise_cloud_discovery_results_aws-<profile>.js\".")
